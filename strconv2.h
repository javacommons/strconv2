...
/* Last Modified: 2021/04/18 17:55 */
#ifndef STRCONV2_H
#define STRCONV2_H
...
#pragma warning(pop)
  ...
  [[nodiscard]] static inline std::wstring format(const wchar_t *format, ...)
  {
    va_list args;
  ...
  [[nodiscard]] static inline std::string format(const char *format, ...)
  {
    va_list args;
    va_start(args, format);
...
#ifdef __cpp_char8_t
  [[nodiscard]] static inline std::string format(const char8_t *format, ...)
  {
    va_list args;
    va_start(args, format);
    std::string s = vformat(format, args);
  ...
  [[nodiscard]] static inline std::string formatA(const wchar_t *format, ...)
  {
    va_list args;
    va_start(args, format);
    std::wstring s = vformat(format, args);
  ...
  [[nodiscard]] static inline std::string formatA(const char *format, ...)
  {
    va_list args;
    va_start(args, format);
    std::string s = vformat(format, args);
...
#ifdef __cpp_char8_t
  [[nodiscard]] static inline std::string formatA(const char8_t *format, ...)
  {
    va_list args;
    va_start(args, format);
    std::string s = vformat(format, args);
